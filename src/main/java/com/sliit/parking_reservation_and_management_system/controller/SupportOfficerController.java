...
public class SupportOfficerController {
    ...
    public String showSupportOfficerDashboard(Model model) {
        try {
            ...
            // Check if user is support officer or admin
            if (!"CUSTOMER_SUPPORT_OFFICER".equals(currentUser.getRole()) && !"ADMIN".equals(currentUser.getRole())) {
    ...
    public String viewAllSupportTickets(Model model,
        ...
        try {
            ...
            if (currentUser == null || (!"CUSTOMER_SUPPORT_OFFICER".equals(currentUser.getRole()) && !"ADMIN".equals(currentUser.getRole()))) {
                return "redirect:/login";
            }
