...
public class ReportService {
    ...
    public void generateFinancialReport(LocalDate startDate, LocalDate endDate, String userEmail) {
        ...
        BigDecimal totalRevenue = reservationRepository.sumTotalCostByReservationDateBetween(startDateTime, endDateTime).orElse(BigDecimal.ZERO);
    ...
    public ReportDetailsDTO getReportDetailsById(Integer reportId) {
        ...
        List<Payment> transactions = paymentRepository.findByPaymentDateBetween(startDateTime, endDateTime);
